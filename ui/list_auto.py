...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # Кнопка удаления
        self.btn_del_auto = QPushButton(self.centralwidget)
        self.btn_del_auto.setObjectName(u"btn_del_auto")
        self.btn_del_auto.setFixedSize(220, 50)
        btn_font = QFont()
        btn_font.setPointSize(12)
        self.btn_del_auto.setFont(btn_font)
        self.verticalLayout.addWidget(self.btn_del_auto, 0, Qt.AlignHCenter)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Управление автопарком", None))
        self.exit.setText(QCoreApplication.translate("MainWindow", u"Назад", None))
        self.btn_del_auto.setText(QCoreApplication.translate("MainWindow", u"Удалить автомобиль", None))